...
export default withOktaAuth(function AddYoutubeLink(props) {
    ...
    <>
      {!loading ? (
        <form autoComplete="off" className="addYoutubeLinkForm">
          {successMessage && (
            <div className="addYoutubeLinkForm__message success">
              {successMessage}
            </div>
          )}
          <TextField
          ...
          <Button
            onClick={async () => props.authService.logout("/")}
            variant="contained"
            color="secondary"
            type="submit"
          >
          ...
          {errorMessage && (
            <div className="addYoutubeLinkForm__message error">
              {errorMessage}
            </div>
          )}
        </form>
